...
DBG_STATIC IXML_Element *gen_specversion(IXML_Document *doc, int major, int minor)
{
	IXML_Element *top;
...
DBG_STATIC IXML_Element *gen_scpd_servicestatetable(IXML_Document *doc, struct service *srv)
{
	IXML_Element *top;
	IXML_Element *child;
	int i;
...
DBG_STATIC IXML_Document *generate_scpd(struct service *srv)
{
	IXML_Document *doc;
	IXML_Element *root;
	IXML_Element *child;
...
DBG_STATIC IXML_Element *gen_desc_iconlist(IXML_Document *doc, struct icon **icons)
{
	IXML_Element *top;
	IXML_Element *parent;
...
DBG_STATIC IXML_Document *generate_desc(struct device *device_def)
{
	IXML_Document *doc;
	IXML_Element *root;
	IXML_Element *child;
...
struct service *find_service(struct device *device_def, char *service_name)
{
